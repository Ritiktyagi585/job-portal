...
<div class="head"><div><h1>My Applications</h1><p>Track the status of your job applications.</p></div><a class="btn light" href="/fast-track/job-recommendations">Browse Jobs</a></div><div class="stats-grid" id="stats"></div><div class="tabs-row"><div class="tabs" id="tabs"></div><select class="sort" id="sortSelect"><option value="newest">Sort by: Newest</option><option value="oldest">Sort by: Oldest</option></select></div><div class="main-grid"><div><div class="app-list" id="applicationList"></div><div class="pager"><button class="page-btn">Previous</button><button class="page-btn active">1</button><button class="page-btn">2</button><button class="page-btn">3</button><button class="page-btn">...</button><button class="page-btn">5</button><button class="page-btn">Next</button></div></div><aside><article class="side-card"><div class="side-head"><h2>Application Tips</h2></div><div class="tips" id="tips"></div><div style="padding:0 20px 18px"><a href="#" style="color:#075fe4;font-weight:700;font-size:13px">View More Tips -></a></div></article><article class="side-card"><div class="side-head"><h2>Upcoming Interviews</h2><a href="#">View All</a></div><div class="interview-list" id="interviews"></div><div style="padding:16px 18px"><a href="#" style="color:#075fe4;font-weight:700;font-size:13px">Prepare for Interviews -></a></div></article></aside></div>
</section>
@endsection
