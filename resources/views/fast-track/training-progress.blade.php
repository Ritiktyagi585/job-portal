...
<div class="head"><h1>Training Progress</h1><p>Track your learning journey and monitor your progress.</p></div><div class="stats-grid" id="cards"></div>
    ...
    <article class="card table-card"><div class="table-top"><h2>Course Progress</h2><a href="/fast-track/courses">View All Courses</a></div><div class="table-wrap"><table><thead><tr><th>Course Name</th><th>Progress</th><th>Status</th><th>Last Studied</th><th></th></tr></thead><tbody id="courseRows"></tbody></table></div></article>
</section>
@endsection
