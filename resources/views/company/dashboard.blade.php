...
<head>
    ...
    <style>
        ...
        .company-sidebar { background: white; border-right: 1px solid #dce7f8; display: flex; flex-direction: column; justify-content: space-between; padding: 28px 18px; box-sizing: border-box; }
        .company-logo img { width: 205px; height: auto; display: block; margin: 0 0 42px; }
        .company-menu { display: grid; gap: 8px; }
        .company-menu-item { position: relative; display: flex; align-items: center; gap: 16px; min-height: 48px; padding: 6px 16px; border-radius: 8px; color: #24344f; font-size: 16px; font-weight: 500; box-sizing: border-box; }
        ...
        .main { padding: 38px; box-sizing: border-box; }
        .topbar { display: flex; align-items: flex-start; justify-content: space-between; gap: 24px; margin-bottom: 28px; }
        .page-title h1 { margin: 0 0 12px; font-size: 30px; font-weight: 700; }
        .page-title p { margin: 0; color: #24344f; font-size: 16px; }
        ...
        .top-user h3 { margin: 0 0 5px; font-size: 16px; font-weight: 700; }
        .top-user p { margin: 0; color: #52607a; font-size: 14px; }
        ...
        .welcome-card h2 { margin: 0 0 12px; font-size: 26px; line-height: 1.25; font-weight: 700; }
        .welcome-card h2 strong { display: block; font-size: 34px; }
        .welcome-card p { margin: 0; color: #34445e; font-size: 16px; }
        ...
        .stat-content h3 { margin: 0 0 6px; font-size: 30px; font-weight: 700; }
        .stat-content p { margin: 0 0 18px; color: #34445e; font-size: 14px; }
        .stat-content a { color: #075fe4; font-size: 14px; font-weight: 700; }
        .content-grid { display: grid; grid-template-columns: 1.1fr 0.9fr; gap: 20px; }
        .panel { padding: 24px; box-sizing: border-box; }
        .panel h2 { margin: 0 0 20px; font-size: 21px; font-weight: 700; }
        ...
        .activity-row h3 { margin: 0; font-size: 14px; font-weight: 700; }
        .activity-row time { color: #34445e; font-size: 13px; }
        ...
        .quick-card h3 { margin: 0 0 6px; font-size: 15px; font-weight: 700; }
        .quick-card p { margin: 0; color: #34445e; font-size: 14px; }
