...
<body>
    <div class="layout">
        <aside class="sidebar">
            ...
            <div class="side-bottom"><div class="upgrade"><h3>Upgrade Your Institute</h3><p>Add more courses and reach thousands of freshers.</p><button class="btn">Upgrade Now</button><div class="upgrade-art">🎓</div></div></div>
        </aside>
        <!-- End Sidebar Section -->
